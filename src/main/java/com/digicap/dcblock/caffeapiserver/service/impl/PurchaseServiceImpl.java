...
//        ReceiptIdVo receiptIdVo = receiptMapper.selectByReceiptId(receiptId);
  ...
  @Override
  public PurchaseBalanceDto getBalanceByRfid(String rfid, Date fromDate, Date toDate)
      throws MyBatisSystemException, NotFindException {
  ...
  getPurchases(Date after, Date before, int filter, int userRecordIndex) {
    ...
    // Get cancel, canceled
    LinkedList<PurchaseNewDto> cancels = purchaseMapper.selectAllCancel(after, before);
